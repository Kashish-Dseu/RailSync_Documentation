...
const canvasItems = [
  { key: "Problem", value: "Fragmented department requests create duplicate blocks, avoidable delays and overdue maintenance." },
  { key: "Solution", value: "An explainable, train-aware planner that coordinates maintenance into fewer, safer work windows." },
  { key: "Unique Value Prop.", value: "AI decides what is important. Deterministic optimization decides when it is safe." },
  { key: "Existing Alternate", value: "Siloed TMS / SMMS / TDMS planning, spreadsheets, calls and manual block coordination." },
  { key: "Cost Structure", value: "Modular monolith, open-source OR-Tools, PostgreSQL, cloud/on-prem deployment and implementation support." },
  { key: "Key Metrics", value: "Blocks avoided, blocked minutes, critical task coverage, train disruption and asset availability." },
  { key: "Unfair Advantage", value: "A railway-domain workflow that makes cross-department shadow blocks visible and auditable." },
  { key: "Revenue Streams", value: "Division pilot, annual platform license, integration services and safety workflow extensions." },
  { key: "Users", value: "Section Controllers, Track / Signal / TRD engineers, DRM / Sr. DOM and system administrators." },
];
...
function BrandMark() {
  return (
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="font-display text-sm font-bold tracking-[0.18em] text-white">BLOCKWISE</div>
        <div className="text-[9px] font-semibold uppercase tracking-[0.24em] text-slate-500">Railway intelligence</div>
      </div>
    </div>
  );
}
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#07111d] text-slate-100 selection:bg-teal-300 selection:text-slate-950">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.06] bg-[#07111d]/85 backdrop-blur-xl">
        <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
          <a href="#top" aria-label="Blockwise home"><BrandMark /></a>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
            <div className="grid items-center gap-14 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16">
              <div className="max-w-2xl">
                ...
                <p className="mt-7 max-w-lg text-base leading-7 text-slate-400 sm:text-lg">Blockwise turns fragmented railway maintenance requests into one explainable, train-aware plan — so teams can protect the network while keeping assets available.</p>
